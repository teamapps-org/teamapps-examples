 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.examples.components.workspace;
...
@TeamAppsDocClass(title = "Multi monitor support")
public class MultiMonitorSupportExample extends AbstractExample {
