 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.examples.components.media.webrtc;
...
@TeamAppsDocClass(title = "Web RTC Publisher")
public class WebRTCPublisherExample extends AbstractExample {
