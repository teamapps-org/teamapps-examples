 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.examples.concepts.sessionhandling;
...
@TeamAppsDocClass(title = "Session Concept")
public class SessionConceptExample extends AbstractExample {
