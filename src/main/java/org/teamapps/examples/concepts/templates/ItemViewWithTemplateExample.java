 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.examples.concepts.templates;
...
@TeamAppsDocClass(title = "Item View with Template")
public class ItemViewWithTemplateExample extends AbstractExample {
