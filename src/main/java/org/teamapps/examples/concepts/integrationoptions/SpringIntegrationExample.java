 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.examples.concepts.integrationoptions;
...
@TeamAppsDocClass(title = "Spring Integration")
public class SpringIntegrationExample extends AbstractExample {
